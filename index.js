...
//const uri = "mongodb+srv://<username>:<password>@cluster0.uiabrwm.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    app.patch('/users', async(req,res)=>{
      ...
      app.get('/products/:brnd',async(req,res)=>{
        const brnd = req.params.brnd;
        const query = {brand: brnd}
